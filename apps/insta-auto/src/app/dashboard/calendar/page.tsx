...
import { IconBrandInstagram, IconArrowLeft, IconPlus } from '@tabler/icons-react';
...
export default async function CalendarPage() {
    ...
    const posts = await prisma.instagramPost.findMany({
        ...
        take: 300,
        select: { id: true, caption: true, status: true, scheduledAt: true, publishedAt: true, createdAt: true },
    });
        ...
        <AppShell header={{ height: 60 }} padding="md">
            <AppShellHeader>
                <Container size="lg" h="100%">
                    <Group h="100%" justify="space-between">
                        ...
                        <Group gap="xs">
                            <Button component="a" href="/dashboard/compose" size="xs" color="grape" leftSection={<IconPlus size={14} />}>새 게시물</Button>
            ...
            <AppShellMain>
                <Container size="lg">
                    ...
                    <Text c="dimmed" size="sm" mb="lg">예약·발행 게시물을 한눈에. 날짜를 클릭하면 그 날짜로 새 게시물을 예약합니다.</Text>
