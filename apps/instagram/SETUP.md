...
- 개발용 크레딧 충전: `cd apps/instagram && npm run seed:credits -- 1000 본인이메일`
...
- 새 프로젝트 `instabot`, Root Directory: `apps/instagram`
- Build: `cd ../.. && npm run build:instagram`
- Install: `cd ../.. && npm install`
- 환경변수: 위 + `NEXTAUTH_URL=https://instabot.amakers.co.kr`
- Cloudflare DNS: `instabot.amakers.co.kr` CNAME → `cname.vercel-dns.com`
