...
- 개발용 크레딧: `cd apps/blog && npm run seed:credits -- 1000 본인이메일`
...
- 새 프로젝트 `blogbot`, Root Directory: `apps/blog`
- Build: `cd ../.. && npm run build:blog`, Install: `cd ../.. && npm install`
- 환경변수 + `NEXTAUTH_URL=https://blogbot.amakers.co.kr`
- Cloudflare DNS: `blogbot.amakers.co.kr` CNAME → `cname.vercel-dns.com`
