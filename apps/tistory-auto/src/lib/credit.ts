/**
 * Credit billing helper — tistoryauto 발행이 이 헬퍼로 차감 (통합 잔액, 모든 봇 공유).
 * 차감은 atomic transaction.
 */

import { prisma } from './prisma';

export type Bot = 'tistoryauto' | 'instabot' | 'marketingbot' | 'pdpbot' | 'designbot' | 'mockupbot' | 'adminbot';
...
export const CREDIT_RATES = {
    PUBLISH: 1, // 티스토리 발행 1회 (에이전트 Phase2 예정)
