...
function LoginInner() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        notifications.show({ title: '로그인 성공', message: '대시보드로 이동합니다.', color: 'orange' });
    ...
    return (
        <Container size={420} my={80}>
            <Stack gap="md" align="center" mb="xl">
                <ThemeIcon variant="gradient" gradient={{ from: 'orange', to: 'red' }} size={56} radius="md">
                    <IconArticle size={32} />
                </ThemeIcon>
                <Title order={2} ta="center">TistoryAuto</Title>
                <Text c="dimmed" ta="center" size="sm">
                    티스토리 자동화봇 — 글 작성부터 예약·발행까지 한 번에.
                </Text>
            </Stack>
