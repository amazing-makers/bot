...
import { IconBrush, IconAlertCircle } from '@tabler/icons-react';
    ...
    return (
        <Container size={420} my={80}>
            <Stack gap="md" align="center" mb="xl">
                <ThemeIcon variant="gradient" gradient={{ from: 'pink', to: 'orange' }} size={56} radius="md">
                    <IconBrush size={32} />
                </ThemeIcon>
                <Title order={2} ta="center">designbot</Title>
                <Text c="dimmed" ta="center" size="sm">
                    AI 디자인봇 — 셀러용 광고·SNS·배너를 5분 만에.
                </Text>
            </Stack>
